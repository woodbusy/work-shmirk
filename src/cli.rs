...
///
/// These characters are hostile on filesystems, in tool integrations that read
/// branch names, and in shells users run inside the worktree. Rejecting them
/// up front produces a clear error before any subprocess runs.
